...
class MainViewModel @ViewModelInject constructor(
    ...
    private val runsSortedByCaloriesBurner = mainRepository.getAllRunSortedByCaloriesBurner()
    ...
    init {
        ...
        runs.addSource(runsSortedByCaloriesBurner) { result ->
    ...
    fun sortRuns(sortType: SortType) = when (sortType) {
        ...
        SortType.CALORIES_BURNED -> runsSortedByCaloriesBurner.value?.let { runs.value = it }
