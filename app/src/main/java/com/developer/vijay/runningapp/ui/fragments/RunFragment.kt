...
import com.developer.vijay.runningapp.adapters.RunAdapter
import com.developer.vijay.runningapp.databinding.FragmentRunBinding
import com.developer.vijay.runningapp.other.Constants
import com.developer.vijay.runningapp.other.SortType
...
class RunFragment : Fragment(), EasyPermissions.PermissionCallbacks {
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentRunBinding.inflate(inflater)
    ...
    override fun onPermissionsDenied(requestCode: Int, perms: MutableList<String>) {
        if (EasyPermissions.somePermissionPermanentlyDenied(this, perms))
            AppSettingsDialog.Builder(this).build()
                .show()  // This will show when user permanently denied permission
        else
            requestPermission()
    }
